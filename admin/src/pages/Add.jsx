...
const Add = ({ token }) => {
	...
	return (
		<form onSubmit={submitHandler} className='flex-flex-col items-start w-full gap-3'>
			<div>
			...
			<div className='w-full'>
				...
				<input onChange={e => setName(e.target.value)} value={name} className='w-full px-3 py-2 max-w-[400px]' type='text' placeholder='type here' required />
			</div>
			<div className='w-full'>
				<p className='mb-2'>Product description</p>
				<textarea onChange={e => setDescription(e.target.value)} value={description} className='w-full px-3 py-2 max-w-[400px]' type='text' placeholder='write content here' required />
			</div>
